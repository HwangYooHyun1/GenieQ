...
#문항 유형
question_example = "윗글을 바탕으로 'OOO'를 이해한 내용으로 적절하지 않은 것은?"
...
문항을 출력하는 형식은 아래와 같다. 
정답 및 해설은 선지 번호( ①, ②, ③, ④, ⑤)를 활용하여 정답 선지의 근거와 오답의 틀린 이유를 포함한 상세 해설을 최소 200자, 최대 300자로 출력해야 한다. 
